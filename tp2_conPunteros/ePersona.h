 ...
 *
 */
int per_mostrarLista(ePersona *, int );
 ...
 *
 */
int per_harcodearDatos(ePersona *);
 ...
 *
 */
int per_incializarEstado(ePersona *, int);
 ...
 *
 */
int per_ordenarPorNombre(ePersona *, int);
 ...
 *
 */
int per_agregarPersona(ePersona *, int, char []);
 ...
 *
 */
int per_pedirDato(ePersona *,int,int);
